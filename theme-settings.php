 ...
 *   The form state.
 */
function horsensportalen_form_system_theme_settings_alter(&$form, &$form_state) {

    $form['mtt_settings'] = array(
        '#type' => 'fieldset',
        '#title' => t('TSGP BaseTheme Settings'),
        '#collapsible' => FALSE,
        '#collapsed' => FALSE,
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['breadcrumb_display'] = array(
        ...
        '#default_value' => theme_get_setting('breadcrumb_display','tsgp_basetheme'),
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['scrolltop_display'] = array(
        ...
        '#default_value' => theme_get_setting('scrolltop_display', 'tsgp_basetheme'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );

    $form['mtt_settings']['tabs']['basic_settings']['animatecss'] = array(
        '#type' => 'checkbox',
        '#title' => t('Include animate.css'),
        '#description'   => t('Use the checkbox to enable or disable animate.css.'),
        '#default_value' => theme_get_setting('animatecss', 'tsgp_basetheme'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );

    $form['mtt_settings']['tabs']['basic_settings']['wowjs'] = array(
        '#type' => 'checkbox',
        '#title' => t('Include wow.js'),
        '#description'   => t('Use the checkbox to enable or disable wow.j.'),
        '#default_value' => theme_get_setting('wowjs', 'tsgp_basetheme'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    */
    ...
    $form['mtt_settings']['tabs']['fontawsome'] = array(
        '#type' => 'fieldset',
        '#title' => t('Font Awesome'),
        '#group' => 'Fontawsome',
    );

    $form['mtt_settings']['tabs']['fontawsome']['fontawesome_cdn'] = array(
        '#type' => 'checkbox',
        '#title' => t('Include Font Awesome CDN'),
        '#default_value' => theme_get_setting('fontawesome_cdn', 'tsgp_basetheme'),
        '#collapsible' => TRUE,
        '#collapsed' => FALSE,
    );
    ...
    $form['mtt_settings']['tabs']['ie8_support']['responsive_respond'] = array(
        ...
        '#default_value' => theme_get_setting('responsive_respond','tsgp_basetheme'),
